...
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=0, color='cyan', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=11, color='blue', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=25, color='green', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=39, color='yellow', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=54, color='orange', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=75, color='red', alpha='1')
