...
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=0, color='0.15', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=11, color='0.3', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=25, color='0.45', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=39, color='0.6', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=54, color='0.75', alpha='1')
plt.fill_between(difficulty, actDifficultyMax, actDifficultyMin, where=difficulty>=75, color='0.9', alpha='1')
