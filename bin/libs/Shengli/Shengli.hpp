...
public:
     ...
     */
    std::string toShengli(std::string english);
     ...
     */
    std::string toEnglish(std::string shengli);
...
private:
     ...
     * @return
     */
    std::string createShengliWord(std::string english);
     ...
     */
    void writeToDictionary(std::string english, std::string shengli);
     ...
     * @return
     */
    std::string findShengliInDictionary(std::string english);
